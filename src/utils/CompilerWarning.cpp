...
/**
 * Constructor: Used in case that the exact code position where the warning
 * occurred is known
 *
 ...
 */
CompilerWarning::CompilerWarning(const CodeLoc &codeLoc,
                                 CompilerWarningType type,
                                 const std::string &message) {
  warningMessage = "[Warning] " + codeLoc.toPrettyString() + ": " +
                   getMessagePrefix(type) + ": " + message;
}

/**
 * Constructor: Used in case the exact code position where the warning occurred
 * is not known
 *
 * @param type Type of the warning
 * @param message Warning message suffix
 */
CompilerWarning::CompilerWarning(CompilerWarningType type,
                                 const std::string &message) {
