...
/**
 * Constructor: Used in case that the exact code position where the error
 * occurred is known
 *
 ...
 */
ParserError::ParserError(const CodeLoc &codeLoc, const ParserErrorType &type,
                         const std::string &message) {
  errorMessage = "[Error|Parser] " + codeLoc.toPrettyString() + ": " +
