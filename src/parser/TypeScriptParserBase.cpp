...
TypeScriptParserBase::TypeScriptParserBase(TokenStream *input)
    : Parser(input) {}

bool TypeScriptParserBase::p(std::string str) { return prev(str); }

bool TypeScriptParserBase::prev(std::string str) {
  return _input->LT(-1)->getText() == str;
}

bool TypeScriptParserBase::n(std::string str) { return next(str); }
